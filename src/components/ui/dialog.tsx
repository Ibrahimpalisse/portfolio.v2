    ...
    >
      ...
      {showClose ? (
        <DialogPrimitive.Close
          className="absolute end-3 top-3 flex h-9 w-9 items-center justify-center rounded-full border border-border bg-card text-foreground/70 transition-colors hover:text-foreground"
...
function DialogHeader({
  ...
  return (
    <div
      className={cn("flex flex-col gap-2 text-center sm:text-start pe-8", className)}
      {...props}
    />
  );
}
